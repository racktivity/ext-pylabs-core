...
class HgClient4Factory:
    ...
    def getclient(self,hgbasedir,remoteUrl,branchname=None, username=None, cleandir=None):
        """
        ...
        """
        return HgClient4(hgbasedir,remoteUrl,branchname, username, cleandir=cleandir)
