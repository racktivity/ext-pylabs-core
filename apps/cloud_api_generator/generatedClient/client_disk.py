...
class disk:
    ...
    def restore (self, backupdiskguid, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.restore(backupdiskguid,diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def canRollback (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.canRollback(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getObject(rootobjectguid,jobguid,executionparams)
    ...
    def listExportedImages (self, diskguid, cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listExportedImages(diskguid,cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getLatestSnapshot (self, diskguid, consistent = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getLatestSnapshot(diskguid,consistent,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def cloneToNewDisk (self, diskguid, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.cloneToNewDisk(diskguid,name,description,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listClones (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listClones(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = None, machineguid = None, disktype = None, windowsdiskname = None, devicename = None, sizefrommb = None, sizetomb = None, compressiontype = None, disklifecycletype = None, templatediskguid = None, iqn = None, status = None, role = None, backuplabel = None, parentdiskguid = None, id = None, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.find(name,machineguid,disktype,windowsdiskname,devicename,sizefrommb,sizetomb,compressiontype,disklifecycletype,templatediskguid,iqn,status,role,backuplabel,parentdiskguid,id,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def iscsiUnExpose (self, diskguid, protocol = "iscsi", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.iscsiUnExpose(diskguid,protocol,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSnapshots (self, diskguid, timestampfrom = "", timestampuntil = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listSnapshots(diskguid,timestampfrom,timestampuntil,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def cloneToExistingDisk (self, diskguid, destinationdiskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.cloneToExistingDisk(diskguid,destinationdiskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def iscsiExpose (self, diskguid, targetIQN = "", username = "", password = "", initiatorIQN = "", ipaddress = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.iscsiExpose(diskguid,targetIQN,username,password,initiatorIQN,ipaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addPartitionFromImage (self, diskguid, imageuri, filesystemtype, imagechecksum = "", size = 0, order = 0, boot = False, backup = False, label = "", mountpoint = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.addPartitionFromImage(diskguid,imageuri,filesystemtype,imagechecksum,size,order,boot,backup,label,mountpoint,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def copyToExistingDisk (self, diskguidsource, diskguiddestination, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.copyToExistingDisk(diskguidsource,diskguiddestination,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listUnmanagedDisks (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listUnmanagedDisks(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateModelProperties (self, diskguid, name = "", description = "", timestamp = "", id = "", iqn = "", devicename = "", status = "", disktype = "", diskorder = "", backendsize = "", dsspolicyguid = "", failovercachestatus = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.updateModelProperties(diskguid,name,description,timestamp,id,iqn,devicename,status,disktype,diskorder,backendsize,dsspolicyguid,failovercachestatus,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeFilesystem (self, diskguid, order, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.removeFilesystem(diskguid,order,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveFailovercacheToMachine (self, diskguid, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.moveFailovercacheToMachine(diskguid,machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setWindowsDiskName (self, diskguid, windowsdiskname, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.setWindowsDiskName(diskguid,windowsdiskname,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def importImage (self, sourceuri, diskguid = "", executormachineguid = "", compressed = True, type = "VDI", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.importImage(sourceuri,diskguid,executormachineguid,compressed,type,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removePartition (self, diskguid, order, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.removePartition(diskguid,order,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def rollback (self, snapshotguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.rollback(snapshotguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def createTemplate (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.createTemplate(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveToMachine (self, diskguid, machineguid, failover = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.moveToMachine(diskguid,machineguid,failover,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addPartition (self, diskguid, size = 0, order = 0, boot = False, backup = False, info = "", filesystem = "", label = "", mountpoint = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.addPartition(diskguid,size,order,boot,backup,info,filesystem,label,mountpoint,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listBackups (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listBackups(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def exportImage (self, diskguid, destinationuri, executormachineguid = "", compressed = True, imagetype = "VDI", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.exportImage(diskguid,destinationuri,executormachineguid,compressed,imagetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listPartitions (self, diskguid, label = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.listPartitions(diskguid,label,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def applyTemplate (self, diskguid, templateguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.applyTemplate(diskguid,templateguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getXML(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def optimize (self, diskguid, scrubagentmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.optimize(diskguid,scrubagentmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addFilesystem (self, diskguid, order, filesystemtype, devicename = "", mountpoint = "", label = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.addFilesystem(diskguid,order,filesystemtype,devicename,mountpoint,label,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXMLSchema (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getXMLSchema(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def canDelete (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.canDelete(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def copyToNewDisk (self, diskguid, size, diskrole = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.copyToNewDisk(diskguid,size,diskrole,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, diskguid = "", name = "", template = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.list(diskguid,name,template,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setSnapshotRetentionPolicy (self, diskguid, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.setSnapshotRetentionPolicy(diskguid,policyguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getYAML(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addRaidConfigurationToPartition (self, diskguid, partitionorder = "", level = "", state = "", devices = "", activeDevices = "", failedDevices = "", spareDevices = "", totalDevices = "", raidDevices = "", backendSize = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.addRaidConfigurationToPartition(diskguid,partitionorder,level,state,devices,activeDevices,failedDevices,spareDevices,totalDevices,raidDevices,backendSize,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def snapshot (self, diskguid, snapshotname = "", label = "", automated = False, async = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.snapshot(diskguid,snapshotname,label,automated,async,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getConfigurationString (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.getConfigurationString(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def backup (self, diskguid, backupname = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.backup(diskguid,backupname,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def create (self, machineguid, name, size, diskrole, diskorder = "", retentionpolicyguid = "", description = "", disksafetytype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.create(machineguid,name,size,diskrole,diskorder,retentionpolicyguid,description,disksafetytype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_disk.delete(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
