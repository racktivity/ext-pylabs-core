...
class cloud:
    ...
    def getXMLSchema (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.getXMLSchema(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def addDatacenter (self, cloudguid, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.addDatacenter(cloudguid,datacenterguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def create (self, name, description = "", datacenterguids = [], dns = "", smtp = "", smtplogin = "", smtppassword = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.create(name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, cloudguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.list(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.getYAML(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.getObject(rootobjectguid,jobguid,executionparams)

            from osis import ROOTOBJECT_TYPES
            import base64
            from osis.model.serializers import ThriftSerializer
            result = base64.decodestring(result['result'])
            result = ROOTOBJECT_TYPES['cloud'].deserialize(ThriftSerializer, result)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def deleteDatacenter (self, cloudguid, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.deleteDatacenter(cloudguid,datacenterguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateModelProperties (self, cloudguid, name = "", description = "", datacenterguids = [], dns = "", smtp = "", smtplogin = "", smtppassword = "", installtype = "", installoption = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.updateModelProperties(cloudguid,name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,installtype,installoption,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listDatacenters (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.listDatacenters(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.getXML(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = "", description = "", datacenterguids = "", dns = "", smtp = "", smtplogin = "", smtppassword = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.find(name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_cloud.delete(cloudguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
