...
class backplane:
    ...
    def listLans (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.listLans(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def getXMLSchema (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.getXMLSchema(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def create (self, name, backplanetype, description = "", publicflag = False, managementflag = False, storageflag = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.create(name,backplanetype,description,publicflag,managementflag,storageflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, backplaneguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.list(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.getYAML(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.getObject(rootobjectguid,jobguid,executionparams)
    ...
    def updateModelProperties (self, backplaneguid, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.updateModelProperties(backplaneguid,name,description,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setFlags (self, backplaneguid, publicflag = False, managementflag = False, storageflag = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.setFlags(backplaneguid,publicflag,managementflag,storageflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.getXML(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = "", managementflag = "", publicflag = "", storageflag = "", backplanetype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.find(name,managementflag,publicflag,storageflag,backplanetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listResourcegroups (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.listResourcegroups(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_backplane.delete(backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
