...
class machinemonitoring:
    ...
    def getDSSDirectorInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getDSSDirectorInfo(jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def getDSSStorageDaemonInfo (self, applicationguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getDSSStorageDaemonInfo(applicationguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVMachineStorageInfo (self, vmachineguid, diskguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getVMachineStorageInfo(vmachineguid,diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPMachineStorageInfo (self, pmachineguid, diskguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getPMachineStorageInfo(pmachineguid,diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getDSSVolumeInfo (self, volumeguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getDSSVolumeInfo(volumeguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPMachineProcesses (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getPMachineProcesses(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPMachineNetworkInfo (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getPMachineNetworkInfo(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVMachinesLoad (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getVMachinesLoad(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPMachinePowerInfo (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getPMachinePowerInfo(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getDSSStoragePoolInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getDSSStoragePoolInfo(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPMachineLoad (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getPMachineLoad(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVMachineLoad (self, vmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getVMachineLoad(vmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getEnvironmentPowerInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machinemonitoring.getEnvironmentPowerInfo(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
