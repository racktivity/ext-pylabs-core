...
class sso:
    ...
    def listSmartClientDevices (self, isfree = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listSmartClientDevices(isfree,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def changePasswordOnPMachines (self, username, newpassword, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.changePasswordOnPMachines(username,newpassword,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSystemNASMachineTemplates (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listSystemNASMachineTemplates(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def syncModel (self, interval = 1440.0, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.syncModel(interval,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addPowerSwitchDevice (self, name, macaddress, cloudspaceguid, description = "", racku = 1, racky = 0, rackz = 0, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addPowerSwitchDevice(name,macaddress,cloudspaceguid,description,racku,racky,rackz,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getAvailableTempDiskSizes (self, diskroletype, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getAvailableTempDiskSizes(diskroletype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def createSnapshots (self, snapshottype = "REGULAR", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.createSnapshots(snapshottype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def snapshotMachine (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.snapshotMachine(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getKioskModeSmartClientInfo (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getKioskModeSmartClientInfo(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listVirtualDesktops (self, cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listVirtualDesktops(cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def scrubVolumes (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.scrubVolumes(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getAvailableFOCNode (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getAvailableFOCNode(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPhysicalDisksCount (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getPhysicalDisksCount(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def shutdown (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.shutdown(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def sendMessageToNoc (self, customerguid, username, password, domain, message, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.sendMessageToNoc(customerguid,username,password,domain,message,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listAvailableCPUNodes (self, memorymin, hypervisor = "", includeappliancehost = "", jobguid = "", executionparams = {}):
        ...
        * Not the CPU node on which the appliance is running.
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listAvailableCPUNodes(memorymin,hypervisor,includeappliancehost,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def sendMail (self, subject, body = "", sender = "", to = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.sendMail(subject,body,sender,to,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def startMachines (self, machineguids = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.startMachines(machineguids,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSmartclientByDevice (self, deviceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listSmartclientByDevice(deviceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getAvailableHypervisors (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getAvailableHypervisors(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def changeAgentPassword (self, oldpwd, newpwd, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.changeAgentPassword(oldpwd,newpwd,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def startApplications (self, applicationguids = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.startApplications(applicationguids,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def validateDomain (self, machineguids = [], domain = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.validateDomain(machineguids,domain,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def deleteSnapshots (self, policyguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.deleteSnapshots(policyguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addDataDisks (self, machineguid, diskinfo = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addDataDisks(machineguid,diskinfo,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addSmartClientDevice (self, name, macaddress, cloudspaceguid, description = "", racku = 1, racky = 0, rackz = 0, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addSmartClientDevice(name,macaddress,cloudspaceguid,description,racku,racky,rackz,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def cleanup (self, maxage = 30, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.cleanup(maxage,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSystemNASISOImages (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listSystemNASISOImages(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def maintenance (self, duration = 3600, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.maintenance(duration,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addVirtualServerFromTemplate (self, cloudspaceguid, templatemachineguid, name, languids = [], description = "", parentmachineguid = "", userinfo = "", vdcinfo = "", defaultgateway = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addVirtualServerFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,defaultgateway,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVirtualMachineDiskInfo (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getVirtualMachineDiskInfo(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addVirtualDesktop (self, cloudspaceguid, name, machinetype = "PHYSICAL", status = "CONFIGURED", bootstatus = "FROMDISK", assetid = "", memory = 0, memoryminimal = 0, nrcpu = 1, cpufrequency = 0, description = "", parentmachineguid = "", networkinfo = [], diskinfo = [], osguid = "", deviceguid = "", hostname = "", backup = "", boot = "", alias = "", userinfo = "", hypervisor = "", importancefactor = "", defaultgateway = "", monitors = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addVirtualDesktop(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,backup,boot,alias,userinfo,hypervisor,importancefactor,defaultgateway,monitors,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVirtualServerInfo (self, macaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getVirtualServerInfo(macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addSmartClientKioskModeFromTemplate (self, cloudspaceguid, templatemachineguid, name, languids = [], description = "", parentmachineguid = "", deviceguid = "", devicename = "", macaddress = "", vdcinfo = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addSmartClientKioskModeFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,deviceguid,devicename,macaddress,vdcinfo,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listFOCVolumes (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listFOCVolumes(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addNode (self, macaddress, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addNode(macaddress,name,description,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVirtualDesktopInfo (self, macaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getVirtualDesktopInfo(macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addVirtualDesktopFromTemplate (self, cloudspaceguid, templatemachineguid, name, languids = [], description = "", parentmachineguid = "", userinfo = "", vdcinfo = "", defaultgateway = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addVirtualDesktopFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,defaultgateway,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def assignDeviceToPowerPort (self, deviceguid, powerswitchdeviceguid, powerportsequence, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.assignDeviceToPowerPort(deviceguid,powerswitchdeviceguid,powerportsequence,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVirtualDesktopClient (self, macaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getVirtualDesktopClient(macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def canMove (self, movementplan = {}, failover = False, minimalcapacity = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.canMove(movementplan,failover,minimalcapacity,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listAvailableStorageDaemons (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listAvailableStorageDaemons(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addSmartClientUserModeFromTemplate (self, cloudspaceguid, templatemachineguid, name, languids = [], description = "", parentmachineguid = "", userinfo = "", vdcinfo = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addSmartClientUserModeFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getSSOVersion (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getSSOVersion(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def applyTemplate (self, diskguid, machineguid, overwrite = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.applyTemplate(diskguid,machineguid,overwrite,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveMachine (self, movementplan = {}, failover = False, minimalcapacity = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.moveMachine(movementplan,failover,minimalcapacity,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def readConfigurationInfo (self, sourceuri, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.readConfigurationInfo(sourceuri,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def stopApplications (self, applicationguids = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.stopApplications(applicationguids,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def restartApplications (self, applicationguids = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.restartApplications(applicationguids,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addSmartClientKioskMode (self, cloudspaceguid, name, machinetype = "PHYSICAL", status = "CONFIGURED", bootstatus = "FROMDISK", assetid = "", memory = 0, memoryminimal = 0, nrcpu = 1, cpufrequency = 0, description = "", parentmachineguid = "", networkinfo = [], diskinfo = [], osguid = "", deviceguid = "", hostname = "", importancefactor = "", backup = "", boot = "", alias = "", devicename = "", macaddress = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addSmartClientKioskMode(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,importancefactor,backup,boot,alias,devicename,macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getApplianceInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getApplianceInfo(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def resetFailoverCache (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.resetFailoverCache(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getFailoverCacheStatus (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getFailoverCacheStatus(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listWebservices (self, action, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listWebservices(action,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getSystemNasInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getSystemNasInfo(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def failoverManagement (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.failoverManagement(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addSmartClientUserMode (self, cloudspaceguid, name, machinetype = "PHYSICAL", status = "CONFIGURED", bootstatus = "FROMDISK", assetid = "", memory = 0, memoryminimal = 0, nrcpu = 1, cpufrequency = 0, description = "", parentmachineguid = "", networkinfo = [], diskinfo = [], osguid = "", deviceguid = "", hostname = "", backup = "", boot = "", alias = "", userinfo = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.addSmartClientUserMode(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,backup,boot,alias,userinfo,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def optimizeDisks (self, diskguids = [], scrubagentmachineguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.optimizeDisks(diskguids,scrubagentmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getAssignedFOCNode (self, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getAssignedFOCNode(diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listAvailableStorageNodes (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listAvailableStorageNodes(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def sendSNMPTrap (self, message, hostdestination = "127.0.0.1", port = 126, community = "aserver", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.sendSNMPTrap(message,hostdestination,port,community,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def initializeNode (self, deviceguid, nodetype, name = "", description = "", hypervisor = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.initializeNode(deviceguid,nodetype,name,description,hypervisor,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setTimezone (self, timezone, timezonedelta = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.setTimezone(timezone,timezonedelta,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def generateMacAddress (self, languid, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.generateMacAddress(languid,customerguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSmartclientByUser (self, clouduserguid, customerguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.listSmartclientByUser(clouduserguid,customerguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVirtualMachineInfo (self, macaddress, machinetype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_sso.getVirtualMachineInfo(macaddress,machinetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
