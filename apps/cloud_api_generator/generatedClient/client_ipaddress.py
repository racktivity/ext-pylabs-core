...
class ipaddress:
    ...
    def getXMLSchema (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.getXMLSchema(ipaddressguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def create (self, name, description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", languid = "", virtual = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.create(name,description,address,netmask,block,iptype,ipversion,languid,virtual,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, ipaddressguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.list(ipaddressguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.getYAML(ipaddressguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.getObject(rootobjectguid,jobguid,executionparams)

            from osis import ROOTOBJECT_TYPES
            import base64
            from osis.model.serializers import ThriftSerializer
            result = base64.decodestring(result['result'])
            result = ROOTOBJECT_TYPES['ipaddress'].deserialize(ThriftSerializer, result)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateModelProperties (self, ipaddressguid, name = "", description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", virtual = None, languid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.updateModelProperties(ipaddressguid,name,description,address,netmask,block,iptype,ipversion,virtual,languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.getXML(ipaddressguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setState (self, ipaddressguid, status, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.setState(ipaddressguid,status,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = "", description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", languid = "", cloudspaceguid = "", virtual = None, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.find(name,description,address,netmask,block,iptype,ipversion,languid,cloudspaceguid,virtual,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_ipaddress.delete(ipaddressguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
