...
class lan:
    ...
    def listVdcs (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.listVdcs(languid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.getObject(rootobjectguid,jobguid,executionparams)
    ...
    def setFromIpToIp (self, languid, fromip, toip, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setFromIpToIp(languid,fromip,toip,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setFlags (self, languid, publicflag = False, managementflag = False, storageflag = False, internetpublicflag = False, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setFlags(languid,publicflag,managementflag,storageflag,internetpublicflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, backplaneguid = "", cloudspaceguid = "", name = "", dns = "", status = "", startip = "", endip = "", gateway = "", managementflag = "", publicflag = "", storageflag = "", network = "", netmask = "", parentlanguid = "", vlantag = "", lantype = "", dhcpflag = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.find(backplaneguid,cloudspaceguid,name,dns,status,startip,endip,gateway,managementflag,publicflag,storageflag,network,netmask,parentlanguid,vlantag,lantype,dhcpflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listMacRanges (self, publicflag = "", managementflag = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.listMacRanges(publicflag,managementflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveToCloudspace (self, languid, spaceguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.moveToCloudspace(languid,spaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def create (self, cloudspaceguid, backplaneguid, name, lantype, parentlanguid = "", network = "", netmask = "", fromip = "", toip = "", gateway = "", dns = "", publicflag = False, internetpublicflag = False, managementflag = False, storageflag = False, description = "", integratedflag = False, nrreservedip = -1, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.create(cloudspaceguid,backplaneguid,name,lantype,parentlanguid,network,netmask,fromip,toip,gateway,dns,publicflag,internetpublicflag,managementflag,storageflag,description,integratedflag,nrreservedip,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setStatus (self, languid, status, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setStatus(languid,status,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getNextMacRange (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.getNextMacRange(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def checkIPRangeInUse (self, startip, endip, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.checkIPRangeInUse(startip,endip,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setLanType (self, languid, lantype, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setLanType(languid,lantype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setNetworkNetmask (self, languid, network, netmask, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setNetworkNetmask(languid,network,netmask,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listIPAddresses (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.listIPAddresses(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setDNS (self, languid, dns, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setDNS(languid,dns,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.getXML(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setDefaultGateway (self, languid, gateway, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setDefaultGateway(languid,gateway,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXMLSchema (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.getXMLSchema(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveToBackplane (self, languid, backplaneguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.moveToBackplane(languid,backplaneguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.getYAML(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listFreeIPAddresses (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.listFreeIPAddresses(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setVlanTag (self, languid, vlantag, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.setVlanTag(languid,vlantag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, languid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_lan.delete(languid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
