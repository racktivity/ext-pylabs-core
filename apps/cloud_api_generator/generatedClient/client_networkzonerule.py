...
class networkzonerule:
    ...
    def getXMLSchema (self, networkzoneruleguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.getXMLSchema(networkzoneruleguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def create (self, name, description = "", sourcenetworkzoneguid = "", destnetworkzoneguid = "", nrhops = 0, gatewayip = "", log = "", disabled = True, freetransit = 0, priority = 0, ipzonerules = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.create(name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, networkzoneruleguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.list(networkzoneruleguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, networkzoneruleguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.getYAML(networkzoneruleguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.getObject(rootobjectguid,jobguid,executionparams)
    ...
    def updateModelProperties (self, networkzoneruleguid, name = "", description = "", sourcenetworkzoneguid = "", destnetworkzoneguid = "", nrhops = 0, gatewayip = "", log = "", disabled = True, freetransit = 0, priority = 0, ipzonerules = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.updateModelProperties(networkzoneruleguid,name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, networkzoneruleguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.getXML(networkzoneruleguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = "", description = "", sourcenetworkzoneguid = "", destnetworkzoneguid = "", nrhops = "", gatewayip = "", log = "", disabled = True, freetransit = "", priority = "", ipzonerules = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.find(name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, networkzoneruleguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_networkzonerule.delete(networkzoneruleguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
