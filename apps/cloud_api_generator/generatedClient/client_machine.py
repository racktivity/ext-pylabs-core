...
class machine:
    ...
    def restore (self, backupmachineguid, restoremachineguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.restore(backupmachineguid,restoremachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
    ...
    def bootInRecoverMode (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.bootInRecoverMode(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def attachToDevice (self, machineguid, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.attachToDevice(machineguid,deviceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def changePassword (self, machineguid, username, newpassword, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.changePassword(machineguid,username,newpassword,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addCapacityProvided (self, machineguid, amount, capacityunittype, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addCapacityProvided(machineguid,amount,capacityunittype,name,description,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getMaximumAllowedIPCount (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getMaximumAllowedIPCount(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def find (self, name = "", assetid = "", alias = "", description = "", macaddress = "", hostname = "", status = "", hypervisor = "", defaultgateway = "", agentguid = "", deviceguid = "", parentmachineguid = "", osguid = "", clouduserguid = "", ownerguid = "", cloudspaceguid = "", resourcegroupguid = "", machinetype = "", template = "", boot = "", customsettings = "", backup = "", backuplabel = "", consistent = "", isbackup = "", ipaddress = "", machinerole = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.find(name,assetid,alias,description,macaddress,hostname,status,hypervisor,defaultgateway,agentguid,deviceguid,parentmachineguid,osguid,clouduserguid,ownerguid,cloudspaceguid,resourcegroupguid,machinetype,template,boot,customsettings,backup,backuplabel,consistent,isbackup,ipaddress,machinerole,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def createFromTemplate (self, cloudspaceguid, templatemachineguid, name, languids = [], description = "", parentmachineguid = "", defaultgateway = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.createFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,defaultgateway,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def pause (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.pause(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def exportMachineTemplates (self, templates = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.exportMachineTemplates(templates,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def rollback (self, machineguid, snapshotmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.rollback(machineguid,snapshotmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateMonitor (self, machineguid, order, name = "", width = "", height = "", bpp = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.updateMonitor(machineguid,order,name,width,height,bpp,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def stop (self, machineguid, clean = True, timeout = 900, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.stop(machineguid,clean,timeout,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def resizeCPU (self, machineguid, nrcpu = 1, cpufrequency = 0, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.resizeCPU(machineguid,nrcpu,cpufrequency,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setSnapshotRetentionPolicy (self, machineguid, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.setSnapshotRetentionPolicy(machineguid,policyguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setVideoMode (self, machineguid, order, xres, yres, bpp, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.setVideoMode(machineguid,order,xres,yres,bpp,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXML (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getXML(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getRole (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getRole(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getApplianceAgent (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getApplianceAgent(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def exportToURI (self, machineguid, destinationuri, executormachineguid = "", compressed = True, diskimagetype = "vdi", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.exportToURI(machineguid,destinationuri,executormachineguid,compressed,diskimagetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def list (self, spaceguid = "", machinetype = "", hypervisor = "", machineguid = "", machinerole = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.list(spaceguid,machinetype,hypervisor,machineguid,machinerole,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def iscsiUnexpose (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.iscsiUnexpose(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listVdcs (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listVdcs(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def exists (self, name = "", assetid = "", cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.exists(name,assetid,cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getVideoMode (self, machineguid, order, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getVideoMode(machineguid,order,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def installDCOS (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.installDCOS(pmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addCapacityConsumed (self, machineguid, amount, capacityunittype, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addCapacityConsumed(machineguid,amount,capacityunittype,name,description,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listExportedImages (self, machineguid, cloudspaceguid = "", machinetype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listExportedImages(machineguid,cloudspaceguid,machinetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def disconnectFromHost (self, machineguid, hostmachineguid, leavecacheintact = False, jobguid = "", executionparams = {}):
        ...
        * disconnect volumes to storage (remove DSS cache data), or make sure vdi's are removed
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.disconnectFromHost(machineguid,hostmachineguid,leavecacheintact,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addMonitor (self, machineguid, width, height, bpp, order = "", name = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addMonitor(machineguid,width,height,bpp,order,name,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setTimeZone (self, machineguid, timezone, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.setTimeZone(machineguid,timezone,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listSnapshots (self, machineguid, includeinconsistent = False, timestampfrom = "", timestampuntil = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listSnapshots(machineguid,includeinconsistent,timestampfrom,timestampuntil,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def resizeMemory (self, machineguid, memory, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.resizeMemory(machineguid,memory,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listAccounts (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listAccounts(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listTemplates (self, spaceguid = "", machinetype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listTemplates(spaceguid,machinetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def reboot (self, machineguid, clean = True, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.reboot(machineguid,clean,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def resume (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.resume(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listBackups (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listBackups(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addTempDisk (self, machineguid, size, name = "", role = "TEMP", retentionpolicyguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addTempDisk(machineguid,size,name,role,retentionpolicyguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def initialize (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.initialize(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getCustomerGuid (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getCustomerGuid(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getXMLSchema (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getXMLSchema(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def registerAgent (self, macaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.registerAgent(macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def importMachineTemplates (self, templates = [], cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.importMachineTemplates(templates,cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getYAML (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getYAML(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeDataDisk (self, machineguid, diskguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeDataDisk(machineguid,diskguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeIpaddress (self, machineguid, macaddress, ipaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeIpaddress(machineguid,macaddress,ipaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def canConnectTempdisks (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.canConnectTempdisks(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getManagementIpaddress (self, machineguid, includevirtual = True, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getManagementIpaddress(machineguid,includevirtual,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getConfigurationString (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getConfigurationString(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getDiskSequences (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getDiskSequences(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setAccountPassword (self, machineguid, accounttype, login, currentpassword, newpassword, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.setAccountPassword(machineguid,accounttype,login,currentpassword,newpassword,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listMonitors (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listMonitors(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def connectToNetworkService (self, machineguid, networkservicename, agentguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.connectToNetworkService(machineguid,networkservicename,agentguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listIpaddresses (self, machineguid, publicflag = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listIpaddresses(machineguid,publicflag,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeNic (self, machineguid, macaddress, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeNic(machineguid,macaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def replace (self, machineguid, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.replace(machineguid,deviceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addAccount (self, machineguid, accounttype, login, password = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addAccount(machineguid,accounttype,login,password,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def reactivate (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.reactivate(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def checkAgent (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.checkAgent(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def executeQshellScript (self, machineguid, qshellscriptcontent, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.executeQshellScript(machineguid,qshellscriptcontent,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def start (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.start(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getAvailableTempdiskSize (self, machineguid, role, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getAvailableTempdiskSize(machineguid,role,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateNic (self, machineguid, macaddress, order, nictype = "", nicstatustype = "", ipaddresses = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.updateNic(machineguid,macaddress,order,nictype,nicstatustype,ipaddresses,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addDataDisk (self, machineguid, size, retentionpolicyguid, name = "", description = "", disksafetytype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addDataDisk(machineguid,size,retentionpolicyguid,name,description,disksafetytype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listCustomerApplications (self, machineguid = "", cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listCustomerApplications(machineguid,cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addIpaddress (self, machineguid, macaddress, languid, ipaddress = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addIpaddress(machineguid,macaddress,languid,ipaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def copy (self, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.copy(jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def connectToHost (self, machineguid, hostmachineguid, failover = False, jobguid = "", executionparams = {}):
        ...
        * when failover=True then the move of machine is forced and to always succeed
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.connectToHost(machineguid,hostmachineguid,failover,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listDisks (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listDisks(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def restartAgent (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.restartAgent(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def delete (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.delete(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getMachineAgent (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getMachineAgent(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def canRollback (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.canRollback(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getObject (self, rootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getObject(rootobjectguid,jobguid,executionparams)
    ...
    def getParentMachine (self, machineguid, machinetype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getParentMachine(machineguid,machinetype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def setRole (self, machineguid, machinerole, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.setRole(machineguid,machinerole,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addISOImage (self, machineguid, sourceuri, name = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addISOImage(machineguid,sourceuri,name,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def changeGateway (self, machineguid, defaultgateway = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.changeGateway(machineguid,defaultgateway,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeCapacityProvided (self, machineguid, capacityunittype, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeCapacityProvided(machineguid,capacityunittype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def iscsiExpose (self, machineguid, targetIQN = "", username = "", password = "", initiatorIQN = "", ipaddress = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.iscsiExpose(machineguid,targetIQN,username,password,initiatorIQN,ipaddress,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def moveToCloudspace (self, machineguid, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.moveToCloudspace(machineguid,cloudspaceguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def bootFromDiskConfigure (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.bootFromDiskConfigure(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def refreshStatus (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.refreshStatus(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def connectToKvm (self, machineguid, agentguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.connectToKvm(machineguid,agentguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def updateModelProperties (self, machineguid, name = "", description = "", cloudspaceguid = "", machinetype = "", osguid = "", assetid = "", alias = "", template = "", hostname = "", nrcpu = "", cpufrequency = "", memory = "", memoryminimal = "", importancefactor = "", lastrealitycheck = "", deviceguid = "", boot = "", customsettings = "", defaultgateway = "", status = "", clouduserguid = "", parentmachineguid = "", hypervisor = "", accounts = "", capacityunitsconsumed = "", capacityunitsprovided = "", nics = "", resourcegroupguid = "", agentguid = "", ownerguid = "", backup = True, backuplabel = "", consistent = "", isbackup = False, iconname = "", timestamp = "", bootstatus = "", monitors = [], jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.updateModelProperties(machineguid,name,description,cloudspaceguid,machinetype,osguid,assetid,alias,template,hostname,nrcpu,cpufrequency,memory,memoryminimal,importancefactor,lastrealitycheck,deviceguid,boot,customsettings,defaultgateway,status,clouduserguid,parentmachineguid,hypervisor,accounts,capacityunitsconsumed,capacityunitsprovided,nics,resourcegroupguid,agentguid,ownerguid,backup,backuplabel,consistent,isbackup,iconname,timestamp,bootstatus,monitors,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def makeTemplate (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.makeTemplate(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def snapshot (self, machineguid, label = "", description = "", automated = False, async = False, snapshottype = "PAUSED", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.snapshot(machineguid,label,description,automated,async,snapshottype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addNic (self, machineguid, nictype, order = 0, macaddress = "", ipaddresses = [], nicstatustype = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addNic(machineguid,nictype,order,macaddress,ipaddresses,nicstatustype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def getPublicIpaddress (self, machineguid, includevirtual = True, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.getPublicIpaddress(machineguid,includevirtual,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def clone (self, machineguid, cloudspaceguid, vdcguid = "", copynetworkinfo = True, maintenancemode = True, name = "", snapshotguid = None, hostmachineguid = None, jobguid = "", executionparams = {}):
        ...
        * the ip addresses are 100% the same as the original ip addresses
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.clone(machineguid,cloudspaceguid,vdcguid,copynetworkinfo,maintenancemode,name,snapshotguid,hostmachineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeAccount (self, machineguid, accounttype, login, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeAccount(machineguid,accounttype,login,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def disable (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.disable(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def importFromURI (self, machineguid, sourceuri, executormachineguid = "", compressed = True, diskimagetype = "vdi", cloudspaceguid = "", clouduserguid = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.importFromURI(machineguid,sourceuri,executormachineguid,compressed,diskimagetype,cloudspaceguid,clouduserguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def addFloppyImage (self, machineguid, sourceuri, name = "", jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.addFloppyImage(machineguid,sourceuri,name,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeCapacityConsumed (self, machineguid, capacityunittype, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeCapacityConsumed(machineguid,capacityunittype,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def detachFromDevice (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.detachFromDevice(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def removeMonitor (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.removeMonitor(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def exportToSecondary (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.exportToSecondary(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listNics (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listNics(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
    ...
    def listGuestMachines (self, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        try:
            result = self._proxy.cloud_api_machine.listGuestMachines(machineguid,jobguid,executionparams)
            return result
        except Exception, ex:
            raise CloudApiException(ex)
