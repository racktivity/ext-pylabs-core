...
from cloud_api_rootobjects import cloud_api_machinemonitoring
from cloud_api.BaseCloudAPI import BaseCloudAPI

class machinemonitoring(BaseCloudAPI):
    def __init__(self):
        self._rootobject = cloud_api_machinemonitoring.machinemonitoring()
	...
	"""
	return self._rootobject.getDSSDirectorInfo(jobguid,executionparams)
	...
	"""
	return self._rootobject.getDSSStorageDaemonInfo(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVMachineStorageInfo(vmachineguid,diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPMachineStorageInfo(pmachineguid,diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getDSSVolumeInfo(volumeguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPMachineProcesses(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPMachineNetworkInfo(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVMachinesLoad(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPMachinePowerInfo(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getDSSStoragePoolInfo(jobguid,executionparams)
	...
	"""
	return self._rootobject.getPMachineLoad(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVMachineLoad(vmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getEnvironmentPowerInfo(jobguid,executionparams)
