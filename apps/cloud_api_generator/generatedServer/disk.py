...
class disk(BaseCloudAPI):
	...
	"""
	return self._rootobject.restore(backupdiskguid,diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.canRollback(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listExportedImages(diskguid,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getLatestSnapshot(diskguid,consistent,jobguid,executionparams)
	...
	"""
	return self._rootobject.cloneToNewDisk(diskguid,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.listClones(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(name,machineguid,disktype,windowsdiskname,devicename,sizefrommb,sizetomb,compressiontype,disklifecycletype,templatediskguid,iqn,status,role,backuplabel,parentdiskguid,id,jobguid,executionparams)
	...
	"""
	return self._rootobject.iscsiUnExpose(diskguid,protocol,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSnapshots(diskguid,timestampfrom,timestampuntil,jobguid,executionparams)
	...
	"""
	return self._rootobject.cloneToExistingDisk(diskguid,destinationdiskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.iscsiExpose(diskguid,targetIQN,username,password,initiatorIQN,ipaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.addPartitionFromImage(diskguid,imageuri,filesystemtype,imagechecksum,size,order,boot,backup,label,mountpoint,jobguid,executionparams)
	...
	"""
	return self._rootobject.copyToExistingDisk(diskguidsource,diskguiddestination,jobguid,executionparams)
	...
	"""
	return self._rootobject.listUnmanagedDisks(jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(diskguid,name,description,timestamp,id,iqn,devicename,status,disktype,diskorder,backendsize,dsspolicyguid,failovercachestatus,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeFilesystem(diskguid,order,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveFailovercacheToMachine(diskguid,machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setWindowsDiskName(diskguid,windowsdiskname,jobguid,executionparams)
	...
	"""
	return self._rootobject.importImage(sourceuri,diskguid,executormachineguid,compressed,type,jobguid,executionparams)
	...
	"""
	return self._rootobject.removePartition(diskguid,order,jobguid,executionparams)
	...
	"""
	return self._rootobject.rollback(snapshotguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.createTemplate(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveToMachine(diskguid,machineguid,failover,jobguid,executionparams)
	...
	"""
	return self._rootobject.addPartition(diskguid,size,order,boot,backup,info,filesystem,label,mountpoint,jobguid,executionparams)
	...
	"""
	return self._rootobject.listBackups(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.exportImage(diskguid,destinationuri,executormachineguid,compressed,imagetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.listPartitions(diskguid,label,jobguid,executionparams)
	...
	"""
	return self._rootobject.applyTemplate(diskguid,templateguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.optimize(diskguid,scrubagentmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addFilesystem(diskguid,order,filesystemtype,devicename,mountpoint,label,jobguid,executionparams)
	...
	"""
	return self._rootobject.canDelete(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.copyToNewDisk(diskguid,size,diskrole,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(diskguid,name,template,jobguid,executionparams)
	...
	"""
	return self._rootobject.setSnapshotRetentionPolicy(diskguid,policyguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addRaidConfigurationToPartition(diskguid,partitionorder,level,state,devices,activeDevices,failedDevices,spareDevices,totalDevices,raidDevices,backendSize,jobguid,executionparams)
	...
	"""
	return self._rootobject.snapshot(diskguid,snapshotname,label,automated,async,jobguid,executionparams)
	...
	"""
	return self._rootobject.getConfigurationString(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.backup(diskguid,backupname,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(machineguid,name,size,diskrole,diskorder,retentionpolicyguid,description,disksafetytype,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(diskguid,jobguid,executionparams)
