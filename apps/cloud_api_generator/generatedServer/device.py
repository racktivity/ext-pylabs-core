...
from cloud_api_rootobjects import cloud_api_device
from cloud_api.BaseCloudAPI import BaseCloudAPI

class device(BaseCloudAPI):
    def __init__(self):
        self._rootobject = cloud_api_device.device()
	...
	"""
	return self._rootobject.getXMLSchema(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addPDisk(deviceguid,status,diskinterfacetype,deviceid,size,rpm,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(name,devicetype,description,template,rackguid,datacenterguid,racku,racky,rackz,modelnr,serialnr,firmware,lastcheck,status,parentdeviceguid,components,pdisks,nicports,powerports,lastrealitycheck,capacityunitsconsumed,capacityunitsprovided,accounts,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listPowerPorts(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(deviceguid,name,devicetype,description,template,rackguid,datacenterguid,racku,racky,rackz,modelnr,serialnr,firmware,lastcheck,status,parentdeviceguid,components,pdisks,nicports,powerports,lastrealitycheck,capacityunitsconsumed,capacityunitsprovided,accounts,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addNic(deviceguid,status,nicporttype,name,sequence,hwaddr,backplaneguid,cableguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(name,macaddress,status,devicetype,description,template,modelnr,serialnr,firmware,rackguid,datacenterguid,parentdeviceguid,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(deviceguid,jobguid,executionparams)
