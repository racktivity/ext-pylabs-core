...
class machine(BaseCloudAPI):
	...
	"""
	return self._rootobject.restore(backupmachineguid,restoremachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.bootInRecoverMode(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.attachToDevice(machineguid,deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.changePassword(machineguid,username,newpassword,jobguid,executionparams)
	...
	"""
	return self._rootobject.addCapacityProvided(machineguid,amount,capacityunittype,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.getMaximumAllowedIPCount(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(name,assetid,alias,description,macaddress,hostname,status,hypervisor,defaultgateway,agentguid,deviceguid,parentmachineguid,osguid,clouduserguid,ownerguid,cloudspaceguid,resourcegroupguid,machinetype,template,boot,customsettings,backup,backuplabel,consistent,isbackup,ipaddress,machinerole,jobguid,executionparams)
	...
	"""
	return self._rootobject.createFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,defaultgateway,jobguid,executionparams)
	...
	"""
	return self._rootobject.pause(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.exportMachineTemplates(templates,jobguid,executionparams)
	...
	"""
	return self._rootobject.rollback(machineguid,snapshotmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateMonitor(machineguid,order,name,width,height,bpp,jobguid,executionparams)
	...
	"""
	return self._rootobject.stop(machineguid,clean,timeout,jobguid,executionparams)
	...
	"""
	return self._rootobject.resizeCPU(machineguid,nrcpu,cpufrequency,jobguid,executionparams)
	...
	"""
	return self._rootobject.setSnapshotRetentionPolicy(machineguid,policyguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setVideoMode(machineguid,order,xres,yres,bpp,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getRole(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getApplianceAgent(jobguid,executionparams)
	...
	"""
	return self._rootobject.exportToURI(machineguid,destinationuri,executormachineguid,compressed,diskimagetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(spaceguid,machinetype,hypervisor,machineguid,machinerole,jobguid,executionparams)
	...
	"""
	return self._rootobject.iscsiUnexpose(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listVdcs(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.exists(name,assetid,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVideoMode(machineguid,order,jobguid,executionparams)
	...
	"""
	return self._rootobject.installDCOS(pmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addCapacityConsumed(machineguid,amount,capacityunittype,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.listExportedImages(machineguid,cloudspaceguid,machinetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.disconnectFromHost(machineguid,hostmachineguid,leavecacheintact,jobguid,executionparams)
	...
	"""
	return self._rootobject.addMonitor(machineguid,width,height,bpp,order,name,jobguid,executionparams)
	...
	"""
	return self._rootobject.setTimeZone(machineguid,timezone,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSnapshots(machineguid,includeinconsistent,timestampfrom,timestampuntil,jobguid,executionparams)
	...
	"""
	return self._rootobject.resizeMemory(machineguid,memory,jobguid,executionparams)
	...
	"""
	return self._rootobject.listAccounts(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listTemplates(spaceguid,machinetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.reboot(machineguid,clean,jobguid,executionparams)
	...
	"""
	return self._rootobject.resume(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listBackups(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addTempDisk(machineguid,size,name,role,retentionpolicyguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.initialize(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getCustomerGuid(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXMLSchema(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.registerAgent(macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.importMachineTemplates(templates,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeDataDisk(machineguid,diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeIpaddress(machineguid,macaddress,ipaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.canConnectTempdisks(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getManagementIpaddress(machineguid,includevirtual,jobguid,executionparams)
	...
	"""
	return self._rootobject.getConfigurationString(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getDiskSequences(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setAccountPassword(machineguid,accounttype,login,currentpassword,newpassword,jobguid,executionparams)
	...
	"""
	return self._rootobject.listMonitors(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.connectToNetworkService(machineguid,networkservicename,agentguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listIpaddresses(machineguid,publicflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeNic(machineguid,macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.replace(machineguid,deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addAccount(machineguid,accounttype,login,password,jobguid,executionparams)
	...
	"""
	return self._rootobject.reactivate(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.checkAgent(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.executeQshellScript(machineguid,qshellscriptcontent,jobguid,executionparams)
	...
	"""
	return self._rootobject.start(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAvailableTempdiskSize(machineguid,role,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateNic(machineguid,macaddress,order,nictype,nicstatustype,ipaddresses,jobguid,executionparams)
	...
	"""
	return self._rootobject.addDataDisk(machineguid,size,retentionpolicyguid,name,description,disksafetytype,jobguid,executionparams)
	...
	"""
	return self._rootobject.listCustomerApplications(machineguid,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addIpaddress(machineguid,macaddress,languid,ipaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.copy(jobguid,executionparams)
	...
	"""
	return self._rootobject.connectToHost(machineguid,hostmachineguid,failover,jobguid,executionparams)
	...
	"""
	return self._rootobject.listDisks(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.restartAgent(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getMachineAgent(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.canRollback(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getParentMachine(machineguid,machinetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.setRole(machineguid,machinerole,jobguid,executionparams)
	...
	"""
	return self._rootobject.addISOImage(machineguid,sourceuri,name,jobguid,executionparams)
	...
	"""
	return self._rootobject.changeGateway(machineguid,defaultgateway,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeCapacityProvided(machineguid,capacityunittype,jobguid,executionparams)
	...
	"""
	return self._rootobject.iscsiExpose(machineguid,targetIQN,username,password,initiatorIQN,ipaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveToCloudspace(machineguid,cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.bootFromDiskConfigure(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.refreshStatus(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.connectToKvm(machineguid,agentguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.makeTemplate(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.snapshot(machineguid,label,description,automated,async,snapshottype,jobguid,executionparams)
	...
	"""
	return self._rootobject.addNic(machineguid,nictype,order,macaddress,ipaddresses,nicstatustype,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPublicIpaddress(machineguid,includevirtual,jobguid,executionparams)
	...
	"""
	return self._rootobject.clone(machineguid,cloudspaceguid,vdcguid,copynetworkinfo,maintenancemode,name,snapshotguid,hostmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeAccount(machineguid,accounttype,login,jobguid,executionparams)
	...
	"""
	return self._rootobject.disable(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.importFromURI(machineguid,sourceuri,executormachineguid,compressed,diskimagetype,cloudspaceguid,clouduserguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addFloppyImage(machineguid,sourceuri,name,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeCapacityConsumed(machineguid,capacityunittype,jobguid,executionparams)
	...
	"""
	return self._rootobject.detachFromDevice(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeMonitor(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.exportToSecondary(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listNics(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listGuestMachines(machineguid,jobguid,executionparams)
