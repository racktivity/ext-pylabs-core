...
class capacityplanning:
	...
	"""
        params =dict()
        executionparams['rootobjecttype'] = 'capacityplanning'

        
        return q.workflowengine.actionmanager.startRootobjectActionSynchronous('capacityplanning', 'listCapacityUnitTypes', params, jobguid=jobguid, executionparams=executionparams)
