...
class networkzonerule(BaseCloudAPI):
    def __init__(self):
	...
	"""
	return self._rootobject.getXMLSchema(networkzoneruleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(networkzoneruleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(networkzoneruleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(networkzoneruleguid,name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(networkzoneruleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(name,description,sourcenetworkzoneguid,destnetworkzoneguid,nrhops,gatewayip,log,disabled,freetransit,priority,ipzonerules,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(networkzoneruleguid,jobguid,executionparams)
