...
class backplane(BaseCloudAPI):
	...
	"""
	return self._rootobject.listLans(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXMLSchema(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(name,backplanetype,description,publicflag,managementflag,storageflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(backplaneguid,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.setFlags(backplaneguid,publicflag,managementflag,storageflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(name,managementflag,publicflag,storageflag,backplanetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.listResourcegroups(backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(backplaneguid,jobguid,executionparams)
