...
class lan(BaseCloudAPI):
	...
	"""
	return self._rootobject.listVdcs(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setFromIpToIp(languid,fromip,toip,jobguid,executionparams)
	...
	"""
	return self._rootobject.setFlags(languid,publicflag,managementflag,storageflag,internetpublicflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(backplaneguid,cloudspaceguid,name,dns,status,startip,endip,gateway,managementflag,publicflag,storageflag,network,netmask,parentlanguid,vlantag,lantype,dhcpflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.listMacRanges(publicflag,managementflag,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveToCloudspace(languid,spaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(cloudspaceguid,backplaneguid,name,lantype,parentlanguid,network,netmask,fromip,toip,gateway,dns,publicflag,internetpublicflag,managementflag,storageflag,description,integratedflag,nrreservedip,jobguid,executionparams)
	...
	"""
	return self._rootobject.setStatus(languid,status,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(languid,name,description,gateway,network,netmask,startip,endip,jobguid,executionparams)
	...
	"""
	return self._rootobject.getNextMacRange(jobguid,executionparams)
	...
	"""
	return self._rootobject.checkIPRangeInUse(startip,endip,jobguid,executionparams)
	...
	"""
	return self._rootobject.setLanType(languid,lantype,jobguid,executionparams)
	...
	"""
	return self._rootobject.setNetworkNetmask(languid,network,netmask,jobguid,executionparams)
	...
	"""
	return self._rootobject.listIPAddresses(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setDNS(languid,dns,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setDefaultGateway(languid,gateway,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXMLSchema(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveToBackplane(languid,backplaneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(cloudspaceguid,backplaneguid,languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listFreeIPAddresses(languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.setVlanTag(languid,vlantag,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(languid,jobguid,executionparams)
