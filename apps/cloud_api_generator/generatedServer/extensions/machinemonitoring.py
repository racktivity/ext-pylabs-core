...
class machinemonitoring:
    ...
    def getDSSDirectorInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getDSSDirectorInfo(jobguid,executionparams)
        return result
    ...
    def getDSSStorageDaemonInfo (self, applicationguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getDSSStorageDaemonInfo(applicationguid,jobguid,executionparams)
        return result
    ...
    def getVMachineStorageInfo (self, vmachineguid, diskguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getVMachineStorageInfo(vmachineguid,diskguid,jobguid,executionparams)
        return result
    ...
    def getPMachineStorageInfo (self, pmachineguid, diskguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getPMachineStorageInfo(pmachineguid,diskguid,jobguid,executionparams)
        return result
    ...
    def getDSSVolumeInfo (self, volumeguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getDSSVolumeInfo(volumeguid,jobguid,executionparams)
        return result
    ...
    def getPMachineProcesses (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getPMachineProcesses(pmachineguid,jobguid,executionparams)
        return result
    ...
    def getPMachineNetworkInfo (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getPMachineNetworkInfo(pmachineguid,jobguid,executionparams)
        return result
    ...
    def getVMachinesLoad (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getVMachinesLoad(pmachineguid,jobguid,executionparams)
        return result
    ...
    def getPMachinePowerInfo (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getPMachinePowerInfo(pmachineguid,jobguid,executionparams)
        return result
    ...
    def getDSSStoragePoolInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getDSSStoragePoolInfo(jobguid,executionparams)
        return result
    ...
    def getPMachineLoad (self, pmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getPMachineLoad(pmachineguid,jobguid,executionparams)
        return result
    ...
    def getVMachineLoad (self, vmachineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getVMachineLoad(vmachineguid,jobguid,executionparams)
        return result
    ...
    def getEnvironmentPowerInfo (self, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getEnvironmentPowerInfo(jobguid,executionparams)
        return result
