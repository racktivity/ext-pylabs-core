...
class vdc:
    ...
    def restore (self, sourcevdcguid, destinationvdcguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.restore(sourcevdcguid,destinationvdcguid,jobguid,executionparams)
        return result
    ...
    def listCloudServices (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listCloudServices(vdcguid,jobguid,executionparams)
        return result
    ...
    def addApplication (self, vdcguid, applicationguid, positionx, positiony, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addApplication(vdcguid,applicationguid,positionx,positiony,jobguid,executionparams)
        return result
    ...
    def listExportedImages (self, vdcguid, cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listExportedImages(vdcguid,cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def addConnection (self, vdcguid, sourcerootobjectguid, destinationrootobjectguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addConnection(vdcguid,sourcerootobjectguid,destinationrootobjectguid,jobguid,executionparams)
        return result
    ...
    def find (self, cloudspaceguid = "", name = "", status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(cloudspaceguid,name,status,jobguid,executionparams)
        return result
    ...
    def removeMachine (self, vdcguid, machineguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeMachine(vdcguid,machineguid,jobguid,executionparams)
        return result
    ...
    def pause (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.pause(vdcguid,jobguid,executionparams)
        return result
    ...
    def addLan (self, vdcguid, languid, positionx, positiony, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addLan(vdcguid,languid,positionx,positiony,jobguid,executionparams)
        return result
    ...
    def create (self, cloudspaceguid, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(cloudspaceguid,name,description,jobguid,executionparams)
        return result
    ...
    def reboot (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.reboot(vdcguid,jobguid,executionparams)
        return result
    ...
    def executeQshellScript (self, vdcguid, qshellScriptContent, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.executeQshellScript(vdcguid,qshellScriptContent,jobguid,executionparams)
        return result
    ...
    def moveToSpace (self, vdcguid, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.moveToSpace(vdcguid,cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def start (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.start(vdcguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, vdcguid, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(vdcguid,name,description,jobguid,executionparams)
        return result
    ...
    def addMachine (self, vdcguid, machineguid, positionx, positiony, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addMachine(vdcguid,machineguid,positionx,positiony,jobguid,executionparams)
        return result
    ...
    def rollback (self, vdcguid, backuplabel, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.rollback(vdcguid,backuplabel,jobguid,executionparams)
        return result
    ...
    def resume (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.resume(vdcguid,jobguid,executionparams)
        return result
    ...
    def clone (self, sourcevdcguid, destinationcloudspaceguid = "", copynetworkinfo = True, maintenancemode = False, autostart = True, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.clone(sourcevdcguid,destinationcloudspaceguid,copynetworkinfo,maintenancemode,autostart,jobguid,executionparams)
        return result
    ...
    def stop (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.stop(vdcguid,jobguid,executionparams)
        return result
    ...
    def initialize (self, vdcguid, start = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.initialize(vdcguid,start,jobguid,executionparams)
        return result
    ...
    def getXML (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(vdcguid,jobguid,executionparams)
        return result
    ...
    def importFromURI (self, vdcguid, sourceuri, executormachineguid = "", jobguid = "", cloudspaceguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.importFromURI(vdcguid,sourceuri,executormachineguid,jobguid,cloudspaceguid,executionparams)
        return result
    ...
    def copy (self, sourcevdcguid, destinationcloudspaceguid = "", copynetworkinfo = True, maintenancemode = False, autostart = True, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.copy(sourcevdcguid,destinationcloudspaceguid,copynetworkinfo,maintenancemode,autostart,jobguid,executionparams)
        return result
    ...
    def removeLan (self, vdcguid, languid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeLan(vdcguid,languid,jobguid,executionparams)
        return result
    ...
    def getXMLSchema (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(vdcguid,jobguid,executionparams)
        return result
    ...
    def exportToURI (self, vdcguid, destinationuri, executormachineguid = "", compressed = True, imagetype = "vdi", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.exportToURI(vdcguid,destinationuri,executormachineguid,compressed,imagetype,jobguid,executionparams)
        return result
    ...
    def list (self, cloudspaceguid = "", vdcguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(cloudspaceguid,vdcguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(vdcguid,jobguid,executionparams)
        return result
    ...
    def removeConnection (self, vdcguid, sourcecloudserviceguid, destinationcloudserviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeConnection(vdcguid,sourcecloudserviceguid,destinationcloudserviceguid,jobguid,executionparams)
        return result
    ...
    def removeApplication (self, vdcguid, applicationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeApplication(vdcguid,applicationguid,jobguid,executionparams)
        return result
    ...
    def snapshot (self, vdcguid, backuplabel, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.snapshot(vdcguid,backuplabel,jobguid,executionparams)
        return result
    ...
    def getConfigurationString (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getConfigurationString(vdcguid,jobguid,executionparams)
        return result
    ...
    def backup (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.backup(vdcguid,jobguid,executionparams)
        return result
    ...
    def delete (self, vdcguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(vdcguid,jobguid,executionparams)
        return result
