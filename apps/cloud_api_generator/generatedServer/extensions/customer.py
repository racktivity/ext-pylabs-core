...
class customer:
    ...
    def removeCapacityAvailable (self, customerguid, capacityunittype, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeCapacityAvailable(customerguid,capacityunittype,jobguid,executionparams)
        return result
    ...
    def listCapacity (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listCapacity(customerguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", status = "", resourcegroupguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,status,resourcegroupguid,jobguid,executionparams)
        return result
    ...
    def unregisterDomain (self, customerguid, username, password, domain, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.unregisterDomain(customerguid,username,password,domain,jobguid,executionparams)
        return result
    ...
    def create (self, name, resourcegroupguid = "", description = "", address = "", city = "", country = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,resourcegroupguid,description,address,city,country,jobguid,executionparams)
        return result
    ...
    def setStatus (self, customerguid, status, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setStatus(customerguid,status,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, customerguid, name = "", description = "", address = "", city = "", country = "", retentionpolicyguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(customerguid,name,description,address,city,country,retentionpolicyguid,jobguid,executionparams)
        return result
    ...
    def listCloudSpaces (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listCloudSpaces(customerguid,jobguid,executionparams)
        return result
    ...
    def addCloudUserGroup (self, customerguid, cloudusergroupguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addCloudUserGroup(customerguid,cloudusergroupguid,jobguid,executionparams)
        return result
    ...
    def registerDomain (self, customerguid, username, password, domain, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.registerDomain(customerguid,username,password,domain,jobguid,executionparams)
        return result
    ...
    def listGroups (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listGroups(customerguid,jobguid,executionparams)
        return result
    ...
    def removeCloudUserGroup (self, customerguid, cloudusergroupguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeCloudUserGroup(customerguid,cloudusergroupguid,jobguid,executionparams)
        return result
    ...
    def getXML (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(customerguid,jobguid,executionparams)
        return result
    ...
    def removeCapacityConsumed (self, customerguid, capacityunittype, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.removeCapacityConsumed(customerguid,capacityunittype,jobguid,executionparams)
        return result
    ...
    def addCapacityConsumed (self, customerguid, amount, capacityunittype, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addCapacityConsumed(customerguid,amount,capacityunittype,name,description,jobguid,executionparams)
        return result
    ...
    def addCapacityAvailable (self, customerguid, amount, capacityunittype, name = "", description = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addCapacityAvailable(customerguid,amount,capacityunittype,name,description,jobguid,executionparams)
        return result
    ...
    def getXMLSchema (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(customerguid,jobguid,executionparams)
        return result
    ...
    def list (self, customerguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(customerguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(customerguid,jobguid,executionparams)
        return result
    ...
    def delete (self, customerguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(customerguid,jobguid,executionparams)
        return result
