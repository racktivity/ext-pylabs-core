...
class dsspolicy:
    ...
    def getXMLSchema (self, dsspolicyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(dsspolicyguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, storageNodes, storageSafety, minSbSize, maxSbSize, spreadLocations, resourceGroup, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,storageNodes,storageSafety,minSbSize,maxSbSize,spreadLocations,resourceGroup,jobguid,executionparams)
        return result
    ...
    def list (self, name = "", status = "", disksafetytype = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(name,status,disksafetytype,jobguid,executionparams)
        return result
    ...
    def getYAML (self, dsspolicyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(dsspolicyguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, dsspolicyguid, status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(dsspolicyguid,status,jobguid,executionparams)
        return result
    ...
    def getXML (self, dsspolicyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(dsspolicyguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", status = "", disksafetytype = "", storagesafety = "", storagewidth = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,status,disksafetytype,storagesafety,storagewidth,jobguid,executionparams)
        return result
