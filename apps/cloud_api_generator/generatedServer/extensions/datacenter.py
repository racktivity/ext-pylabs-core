...
class datacenter:
    ...
    def listClouds (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listClouds(datacenterguid,jobguid,executionparams)
        return result
    ...
    def getXMLSchema (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(datacenterguid,jobguid,executionparams)
        return result
    ...
    def listRacks (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listRacks(datacenterguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, description = "", locationguid = "", clouduserguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,description,locationguid,clouduserguid,jobguid,executionparams)
        return result
    ...
    def list (self, datacenterguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(datacenterguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(datacenterguid,jobguid,executionparams)
        return result
    ...
    def listNetworkzones (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listNetworkzones(datacenterguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, datacenterguid, name = "", description = "", locationguid = "", clouduserguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(datacenterguid,name,description,locationguid,clouduserguid,jobguid,executionparams)
        return result
    ...
    def getXML (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(datacenterguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", description = "", locationguid = "", clouduserguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,description,locationguid,clouduserguid,jobguid,executionparams)
        return result
    ...
    def listResourceGroups (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listResourceGroups(datacenterguid,jobguid,executionparams)
        return result
    ...
    def delete (self, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(datacenterguid,jobguid,executionparams)
        return result
