...
class dssnamespace:
    ...
    def getSpreads (self, namespaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getSpreads(namespaceguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, dsspolicyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,dsspolicyguid,jobguid,executionparams)
        return result
    ...
    def getnamespaceinfo (self, namespaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getnamespaceinfo(namespaceguid,jobguid,executionparams)
        return result
    ...
    def getnextobjectid (self, namespaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getnextobjectid(namespaceguid,jobguid,executionparams)
        return result
    ...
    def updateSpreads (self, namespaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateSpreads(namespaceguid,jobguid,executionparams)
        return result
    ...
    def verifyobject (self, namespaceguid, objectid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.verifyobject(namespaceguid,objectid,jobguid,executionparams)
        return result
    ...
    def getobjectinfo (self, namespaceguid, objectid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getobjectinfo(namespaceguid,objectid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", dsspolicyguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,dsspolicyguid,jobguid,executionparams)
        return result
    ...
    def delete (self, dssnamespaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(dssnamespaceguid,jobguid,executionparams)
        return result
