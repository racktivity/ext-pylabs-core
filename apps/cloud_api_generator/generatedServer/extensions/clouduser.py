...
class clouduser:
    ...
    def listJobs (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listJobs(clouduserguid,jobguid,executionparams)
        return result
    ...
    def listGroups (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listGroups(clouduserguid,jobguid,executionparams)
        return result
    ...
    def getXMLSchema (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(clouduserguid,jobguid,executionparams)
        return result
    ...
    def generateCertificate (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.generateCertificate(clouduserguid,jobguid,executionparams)
        return result
    ...
    def create (self, login, password, email = "", firstname = "", lastname = "", name = "", description = "", systemUser = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(login,password,email,firstname,lastname,name,description,systemUser,jobguid,executionparams)
        return result
    ...
    def list (self, clouduserguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(clouduserguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(clouduserguid,jobguid,executionparams)
        return result
    ...
    def setAdminFlag (self, clouduserguid, isAdmin = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setAdminFlag(clouduserguid,isAdmin,jobguid,executionparams)
        return result
    ...
    def listMachines (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listMachines(clouduserguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, clouduserguid, name = "", description = "", email = "", firstname = "", lastname = "", address = "", city = "", country = "", phonemobile = "", phonelandline = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(clouduserguid,name,description,email,firstname,lastname,address,city,country,phonemobile,phonelandline,jobguid,executionparams)
        return result
    ...
    def listDatacenters (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listDatacenters(clouduserguid,jobguid,executionparams)
        return result
    ...
    def updatePassword (self, clouduserguid, currentpassword, newpassword, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updatePassword(clouduserguid,currentpassword,newpassword,jobguid,executionparams)
        return result
    ...
    def getXML (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(clouduserguid,jobguid,executionparams)
        return result
    ...
    def setStatus (self, clouduserguid, status, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setStatus(clouduserguid,status,jobguid,executionparams)
        return result
    ...
    def find (self, login = "", email = "", name = "", status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(login,email,name,status,jobguid,executionparams)
        return result
    ...
    def delete (self, clouduserguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(clouduserguid,jobguid,executionparams)
        return result
