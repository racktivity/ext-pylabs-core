...
class policy:
    ...
    def getXMLSchema (self, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(policyguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, rootobjecttype, rootobjectaction, rootobjectguid, interval, runbetween = None, runnotbetween = None, policyparams = None, description = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,rootobjecttype,rootobjectaction,rootobjectguid,interval,runbetween,runnotbetween,policyparams,description,jobguid,executionparams)
        return result
    ...
    def list (self, policyguid = "", name = "", rootobjectaction = "", rootobjecttype = "", status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(policyguid,name,rootobjectaction,rootobjecttype,status,jobguid,executionparams)
        return result
    ...
    def getYAML (self, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(policyguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, policyguid, name = "", description = "", lastrun = "", status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(policyguid,name,description,lastrun,status,jobguid,executionparams)
        return result
    ...
    def getXML (self, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(policyguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", description = "", rootobjecttype = "", rootobjectaction = "", rootobjectguid = "", interval = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,description,rootobjecttype,rootobjectaction,rootobjectguid,interval,jobguid,executionparams)
        return result
    ...
    def delete (self, policyguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(policyguid,jobguid,executionparams)
        return result
