...
class cloud:
    ...
    def getXMLSchema (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(cloudguid,jobguid,executionparams)
        return result
    ...
    def addDatacenter (self, cloudguid, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addDatacenter(cloudguid,datacenterguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, description = "", datacenterguids = [], dns = "", smtp = "", smtplogin = "", smtppassword = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,jobguid,executionparams)
        return result
    ...
    def list (self, cloudguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(cloudguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(cloudguid,jobguid,executionparams)
        return result
    ...
    def deleteDatacenter (self, cloudguid, datacenterguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.deleteDatacenter(cloudguid,datacenterguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, cloudguid, name = "", description = "", datacenterguids = [], dns = "", smtp = "", smtplogin = "", smtppassword = "", installtype = "", installoption = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(cloudguid,name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,installtype,installoption,jobguid,executionparams)
        return result
    ...
    def listDatacenters (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listDatacenters(cloudguid,jobguid,executionparams)
        return result
    ...
    def getXML (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(cloudguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", description = "", datacenterguids = "", dns = "", smtp = "", smtplogin = "", smtppassword = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,description,datacenterguids,dns,smtp,smtplogin,smtppassword,jobguid,executionparams)
        return result
    ...
    def delete (self, cloudguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(cloudguid,jobguid,executionparams)
        return result
