...
class cloudspace:
    ...
    def listVdcs (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listVdcs(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def listLans (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listLans(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def listApplications (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listApplications(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def getXMLSchema (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def create (self, customerguid, name, description = "", parentcloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(customerguid,name,description,parentcloudspaceguid,jobguid,executionparams)
        return result
    ...
    def list (self, customerguid = "", cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(customerguid,cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def setStatus (self, cloudspaceguid, status, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setStatus(cloudspaceguid,status,jobguid,executionparams)
        return result
    ...
    def getXML (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def listDevices (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listDevices(cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def find (self, customerguid = "", parentcloudspaceguid = "", name = "", status = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(customerguid,parentcloudspaceguid,name,status,jobguid,executionparams)
        return result
    ...
    def delete (self, cloudspaceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(cloudspaceguid,jobguid,executionparams)
        return result
