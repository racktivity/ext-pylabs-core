...
class ipaddress:
    ...
    def getXMLSchema (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(ipaddressguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", languid = "", virtual = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,description,address,netmask,block,iptype,ipversion,languid,virtual,jobguid,executionparams)
        return result
    ...
    def list (self, ipaddressguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(ipaddressguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(ipaddressguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, ipaddressguid, name = "", description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", virtual = None, languid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(ipaddressguid,name,description,address,netmask,block,iptype,ipversion,virtual,languid,jobguid,executionparams)
        return result
    ...
    def getXML (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(ipaddressguid,jobguid,executionparams)
        return result
    ...
    def setState (self, ipaddressguid, status, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setState(ipaddressguid,status,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", description = "", address = "", netmask = "", block = False, iptype = "", ipversion = "", languid = "", cloudspaceguid = "", virtual = None, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,description,address,netmask,block,iptype,ipversion,languid,cloudspaceguid,virtual,jobguid,executionparams)
        return result
    ...
    def delete (self, ipaddressguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(ipaddressguid,jobguid,executionparams)
        return result
