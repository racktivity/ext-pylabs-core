...
class rack:
    ...
    def getXMLSchema (self, rackguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(rackguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, racktype, description = "", datacenterguid = "", floor = "", corridor = "", position = "", height = 42, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,racktype,description,datacenterguid,floor,corridor,position,height,jobguid,executionparams)
        return result
    ...
    def list (self, rackguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(rackguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, rackguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(rackguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, rackguid, name = "", racktype = "", description = "", datacenterguid = "", floor = "", corridor = "", position = "", height = 42, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(rackguid,name,racktype,description,datacenterguid,floor,corridor,position,height,jobguid,executionparams)
        return result
    ...
    def getXML (self, rackguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(rackguid,jobguid,executionparams)
        return result
    ...
    def listDevices (self, rackguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listDevices(rackguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", racktype = "", description = "", datacenterguid = "", floor = "", corridor = "", position = "", height = 42, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,racktype,description,datacenterguid,floor,corridor,position,height,jobguid,executionparams)
        return result
    ...
    def delete (self, rackguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(rackguid,jobguid,executionparams)
        return result
