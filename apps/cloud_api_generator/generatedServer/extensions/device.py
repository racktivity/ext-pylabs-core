...
class device:
    ...
    def getXMLSchema (self, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(deviceguid,jobguid,executionparams)
        return result
    ...
    def addPDisk (self, deviceguid, status, diskinterfacetype, deviceid = "", size = "", rpm = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addPDisk(deviceguid,status,diskinterfacetype,deviceid,size,rpm,jobguid,executionparams)
        return result
    ...
    def create (self, name, devicetype, description = "", template = False, rackguid = "", datacenterguid = "", racku = 1, racky = 0, rackz = 0, modelnr = "", serialnr = "", firmware = "", lastcheck = "", status = "", parentdeviceguid = "", components = [], pdisks = [], nicports = [], powerports = [], lastrealitycheck = "", capacityunitsconsumed = [], capacityunitsprovided = [], accounts = "", cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,devicetype,description,template,rackguid,datacenterguid,racku,racky,rackz,modelnr,serialnr,firmware,lastcheck,status,parentdeviceguid,components,pdisks,nicports,powerports,lastrealitycheck,capacityunitsconsumed,capacityunitsprovided,accounts,cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def list (self, deviceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(deviceguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(deviceguid,jobguid,executionparams)
        return result
    ...
    def listPowerPorts (self, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listPowerPorts(deviceguid,jobguid,executionparams)
        return result
    ...
    def getXML (self, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(deviceguid,jobguid,executionparams)
        return result
    ...
    def addNic (self, deviceguid, status, nicporttype, name = "", sequence = "", hwaddr = "", backplaneguid = "", cableguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.addNic(deviceguid,status,nicporttype,name,sequence,hwaddr,backplaneguid,cableguid,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", macaddress = "", status = "", devicetype = "", description = "", template = "", modelnr = "", serialnr = "", firmware = "", rackguid = "", datacenterguid = "", parentdeviceguid = "", cloudspaceguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,macaddress,status,devicetype,description,template,modelnr,serialnr,firmware,rackguid,datacenterguid,parentdeviceguid,cloudspaceguid,jobguid,executionparams)
        return result
    ...
    def delete (self, deviceguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(deviceguid,jobguid,executionparams)
        return result
