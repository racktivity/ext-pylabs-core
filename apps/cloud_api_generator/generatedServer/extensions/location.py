...
class location:
    ...
    def getXMLSchema (self, locationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXMLSchema(locationguid,jobguid,executionparams)
        return result
    ...
    def create (self, name, description = "", alias = "", address = "", city = "", country = "", public = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.create(name,description,alias,address,city,country,public,jobguid,executionparams)
        return result
    ...
    def list (self, locationguid = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.list(locationguid,jobguid,executionparams)
        return result
    ...
    def getYAML (self, locationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getYAML(locationguid,jobguid,executionparams)
        return result
    ...
    def updateModelProperties (self, locationguid, name = "", description = "", alias = "", address = "", city = "", country = "", public = False, timezonename = "", timezonedelta = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.updateModelProperties(locationguid,name,description,alias,address,city,country,public,timezonename,timezonedelta,jobguid,executionparams)
        return result
    ...
    def listDatacenters (self, locationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.listDatacenters(locationguid,jobguid,executionparams)
        return result
    ...
    def getXML (self, locationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.getXML(locationguid,jobguid,executionparams)
        return result
    ...
    def setTimeZone (self, locationguid, timezonename, timezonedelta = "", jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.setTimeZone(locationguid,timezonename,timezonedelta,jobguid,executionparams)
        return result
    ...
    def find (self, name = "", description = "", alias = "", address = "", city = "", country = "", public = False, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.find(name,description,alias,address,city,country,public,jobguid,executionparams)
        return result
    ...
    def delete (self, locationguid, jobguid = "", executionparams = {}):
        ...
        """
        result = self._rootobject.delete(locationguid,jobguid,executionparams)
        return result
