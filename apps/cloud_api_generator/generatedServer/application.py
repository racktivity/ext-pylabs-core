...
class application(BaseCloudAPI):
    def __init__(self):
	...
	"""
	return self._rootobject.listVdcs(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.restore(sourceapplicationguid,destinationapplicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeNetworkService(applicationguid,servicename,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeService(applicationguid,servicename,jobguid,executionparams)
	...
	"""
	return self._rootobject.exists(templatename,machineguid,customer,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToDevice(applicationguid,servicename,deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listAccountTypes(jobguid,executionparams)
	...
	"""
	return self._rootobject.listMonitoringInfo(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getChildApplications(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.initialize(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToNetworkZone(applicationguid,servicename,networkzoneguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addCapacityProvided(applicationguid,amount,capacityunittype,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.addAccount(applicationguid,login,password,accounttype,jobguid,executionparams)
	...
	"""
	return self._rootobject.find(cloudspaceguid,machineguid,name,status,istemplate,customer,mode,monitor,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToApplication(applicationguid,servicename,destinationapplicationguid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.createFromTemplate(cloudspaceguid,machineguid,applicationtemplateguid,name,description,customsettings,customer,jobguid,executionparams)
	...
	"""
	return self._rootobject.copy(sourceapplicationguid,destinationapplicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToDevice(applicationguid,servicename,deviceguid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.reload(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeCapacityProvided(applicationguid,capacityunittype,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(cloudspaceguid,name,machineguid,parentapplicactionguid,description,customsettings,customer,mode,jobguid,executionparams)
	...
	"""
	return self._rootobject.getStatus(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToCloudUser(applicationguid,servicename,clouduserguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.start(applicationguid,failifnotenoughresource,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(applicationguid,name,description,status,customsettings,customer,mode,monitor,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToDisk(applicationguid,servicename,diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getApplicationTemplate(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToLan(applicationguid,servicename,languid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToMachine(applicationguid,servicename,machineguid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.getNetworkServicePorts(applicationguid,networkservicename,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveToMachine(applicationguid,machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToCloudUser(applicationguid,servicename,clouduserguid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.addNetworkService(applicationguid,name,description,enabled,monitored,ipaddressguids,jobguid,executionparams)
	...
	"""
	return self._rootobject.stop(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeAccount(applicationguid,login,accounttype,jobguid,executionparams)
	...
	"""
	return self._rootobject.disable(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addService(applicationguid,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.importFromURI(applicationguid,sourceuri,executormachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAgentsForCloudService(cloudservicename,applicationtype,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToApplication(applicationguid,servicename,destinationapplicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.restart(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listNetworkServices(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeCapacityConsumed(applicationguid,capacityunittype,jobguid,executionparams)
	...
	"""
	return self._rootobject.addCapacityConsumed(applicationguid,amount,capacityunittype,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.uninstall(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addNetworkServicePort(applicationguid,servicename,portnr,protocoltype,ipaddress,monitor,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAgentForApplicationTypeService(machineguid,applicationtype,jobguid,executionparams)
	...
	"""
	return self._rootobject.exportToURI(applicationguid,destinationuri,executormachineguid,compressed,imagetype,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(cloudspaceguid,machineguid,applicationguid,status,customer,istemplate,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToNetworkZone(applicationguid,servicename,networkzoneguid,remark,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToMachine(applicationguid,servicename,machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXMLSchema(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.revokeServiceToLan(applicationguid,servicename,languid,jobguid,executionparams)
	...
	"""
	return self._rootobject.offerServiceToDisk(applicationguid,servicename,diskguid,remark,partitionorder,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAgent(applicationguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.backup(applicationguid,destinationuri,compressed,login,password,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeNetworkServicePort(applicationguid,servicename,portnr,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(applicationguid,jobguid,executionparams)
