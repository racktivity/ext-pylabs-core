...
class cloudusergroup(BaseCloudAPI):
    def __init__(self):
	...
	"""
	return self._rootobject.listGroups(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXMLSchema(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addUser(cloudusergroupguid,clouduserguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.create(name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeUserRole(cloudusergroupguid,clouduserroleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.list(customerguid,cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeGroup(cloudusergroupguid,membercloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getYAML(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listUsers(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listRoles(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.removeUser(cloudusergroupguid,clouduserguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.updateModelProperties(cloudusergroupguid,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.listCustomers(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addGroup(cloudusergroupguid,membercloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getXML(cloudusergroupguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addUserRole(cloudusergroupguid,clouduserroleguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.delete(cloudusergroupguid,jobguid,executionparams)
