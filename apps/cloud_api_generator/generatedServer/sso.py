...
class sso(BaseCloudAPI):
	...
	"""
	return self._rootobject.listSmartClientDevices(isfree,jobguid,executionparams)
	...
	"""
	return self._rootobject.changePasswordOnPMachines(username,newpassword,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSystemNASMachineTemplates(jobguid,executionparams)
	...
	"""
	return self._rootobject.syncModel(interval,jobguid,executionparams)
	...
	"""
	return self._rootobject.addPowerSwitchDevice(name,macaddress,cloudspaceguid,description,racku,racky,rackz,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAvailableTempDiskSizes(diskroletype,jobguid,executionparams)
	...
	"""
	return self._rootobject.createSnapshots(snapshottype,jobguid,executionparams)
	...
	"""
	return self._rootobject.snapshotMachine(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getKioskModeSmartClientInfo(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listVirtualDesktops(cloudspaceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.scrubVolumes(jobguid,executionparams)
	...
	"""
	return self._rootobject.getAvailableFOCNode(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getPhysicalDisksCount(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.shutdown(jobguid,executionparams)
	...
	"""
	return self._rootobject.sendMessageToNoc(customerguid,username,password,domain,message,jobguid,executionparams)
	...
	"""
	return self._rootobject.listAvailableCPUNodes(memorymin,hypervisor,includeappliancehost,jobguid,executionparams)
	...
	"""
	return self._rootobject.sendMail(subject,body,sender,to,jobguid,executionparams)
	...
	"""
	return self._rootobject.startMachines(machineguids,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSmartclientByDevice(deviceguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAvailableHypervisors(jobguid,executionparams)
	...
	"""
	return self._rootobject.changeAgentPassword(oldpwd,newpwd,jobguid,executionparams)
	...
	"""
	return self._rootobject.startApplications(applicationguids,jobguid,executionparams)
	...
	"""
	return self._rootobject.validateDomain(machineguids,domain,jobguid,executionparams)
	...
	"""
	return self._rootobject.deleteSnapshots(policyguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addDataDisks(machineguid,diskinfo,jobguid,executionparams)
	...
	"""
	return self._rootobject.addSmartClientDevice(name,macaddress,cloudspaceguid,description,racku,racky,rackz,jobguid,executionparams)
	...
	"""
	return self._rootobject.cleanup(maxage,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSystemNASISOImages(jobguid,executionparams)
	...
	"""
	return self._rootobject.maintenance(duration,jobguid,executionparams)
	...
	"""
	return self._rootobject.addVirtualServerFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,defaultgateway,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVirtualMachineDiskInfo(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addVirtualDesktop(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,backup,boot,alias,userinfo,hypervisor,importancefactor,defaultgateway,monitors,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVirtualServerInfo(macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.addSmartClientKioskModeFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,deviceguid,devicename,macaddress,vdcinfo,jobguid,executionparams)
	...
	"""
	return self._rootobject.listFOCVolumes(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addNode(macaddress,name,description,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVirtualDesktopInfo(macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.addVirtualDesktopFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,defaultgateway,jobguid,executionparams)
	...
	"""
	return self._rootobject.assignDeviceToPowerPort(deviceguid,powerswitchdeviceguid,powerportsequence,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVirtualDesktopClient(macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.canMove(movementplan,failover,minimalcapacity,jobguid,executionparams)
	...
	"""
	return self._rootobject.listAvailableStorageDaemons(jobguid,executionparams)
	...
	"""
	return self._rootobject.addSmartClientUserModeFromTemplate(cloudspaceguid,templatemachineguid,name,languids,description,parentmachineguid,userinfo,vdcinfo,jobguid,executionparams)
	...
	"""
	return self._rootobject.getSSOVersion(jobguid,executionparams)
	...
	"""
	return self._rootobject.applyTemplate(diskguid,machineguid,overwrite,jobguid,executionparams)
	...
	"""
	return self._rootobject.moveMachine(movementplan,failover,minimalcapacity,jobguid,executionparams)
	...
	"""
	return self._rootobject.readConfigurationInfo(sourceuri,jobguid,executionparams)
	...
	"""
	return self._rootobject.stopApplications(applicationguids,jobguid,executionparams)
	...
	"""
	return self._rootobject.restartApplications(applicationguids,jobguid,executionparams)
	...
	"""
	return self._rootobject.addSmartClientKioskMode(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,importancefactor,backup,boot,alias,devicename,macaddress,jobguid,executionparams)
	...
	"""
	return self._rootobject.getApplianceInfo(jobguid,executionparams)
	...
	"""
	return self._rootobject.resetFailoverCache(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getFailoverCacheStatus(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listWebservices(action,jobguid,executionparams)
	...
	"""
	return self._rootobject.getSystemNasInfo(jobguid,executionparams)
	...
	"""
	return self._rootobject.failoverManagement(machineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.addSmartClientUserMode(cloudspaceguid,name,machinetype,status,bootstatus,assetid,memory,memoryminimal,nrcpu,cpufrequency,description,parentmachineguid,networkinfo,diskinfo,osguid,deviceguid,hostname,backup,boot,alias,userinfo,jobguid,executionparams)
	...
	"""
	return self._rootobject.optimizeDisks(diskguids,scrubagentmachineguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getAssignedFOCNode(diskguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listAvailableStorageNodes(jobguid,executionparams)
	...
	"""
	return self._rootobject.sendSNMPTrap(message,hostdestination,port,community,jobguid,executionparams)
	...
	"""
	return self._rootobject.initializeNode(deviceguid,nodetype,name,description,hypervisor,jobguid,executionparams)
	...
	"""
	return self._rootobject.setTimezone(timezone,timezonedelta,jobguid,executionparams)
	...
	"""
	return self._rootobject.generateMacAddress(languid,customerguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.listSmartclientByUser(clouduserguid,customerguid,jobguid,executionparams)
	...
	"""
	return self._rootobject.getVirtualMachineInfo(macaddress,machinetype,jobguid,executionparams)
