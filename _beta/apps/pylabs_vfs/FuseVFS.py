...
#            print "mythread: ticking"
    ...
    def readdir(self, path, offset):
        ...
        try:
            dirObject = self.vfs.dirObjectGet(path[1:])
            entries = sorted(dirObject.dirs.keys()) + sorted(dirObject.files.keys())
...
#        return aa
    ...
    def fsinit(self):
        self.vfs=VFSMetadata(self.root,"/opt/qbase5/var/log")  #scan log dir and create metadata store for it
        self.vfs.reset()
