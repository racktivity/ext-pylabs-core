class group:
    ...
    def create(self, name, permissions, jobguid="", executionparams=dict()):
        """
        Create an activity
    ...
    def delete(self, groupguid, jobguid="", executionparams=dict()):
        """
    ...
    def cancel(self, groupguid, jobguid="", executionparams=dict()):
        """
        Cancel activity
    ...
    def find(self, groupguid=None, name=None, permissions=None, jobguid=None, executionparams=dict()):
        """
    ...
    def getObject(self, groupguid, jobguid="",executionparams=dict()):
        """
    ...
    def update (self, groupguid, name, permissions, jobguid=None, executionparams={}):
        """
        Update an activity
