class permission:
    ...
    def create(self, name, uri, jobguid="", executionparams=dict()):
        """
        Create an activity
    ...
    def delete(self, permissionguid, jobguid="", executionparams=dict()):
        """
    ...
    def cancel(self, permissionguid, jobguid="", executionparams=dict()):
        """
        Cancel activity
    ...
    def find(self, permissionguid=None, name=None, uri=None, jobguid=None, executionparams=dict()):
        """
    ...
    def getObject(self, permissionguid, jobguid="",executionparams=dict()):
        """
    ...
    def update (self, permissionguid, name, uri, jobguid=None, executionparams={}):
        """
        Update an activity
