#OSIS Views
As explained in the [PyApp architecture] (sampleapp.md), OSIS stands for Object Store and Indexing System. OSIS is responsible for populating the [Arakoon] (http://www.arakoon.org) object store as well as a PostgreSQL database.
...
* name of a root object property, as defined in the [Root Object Model] (modeling.md)
