...
##Example Consumer
You must create the consumer files in the following directory: ``<pyapp name>/impl/events/<event process>`. See the [PyApps Directory Structure] (sampleapp.md) for more information about the location of the files.
