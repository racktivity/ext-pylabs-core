...
__tags__ = 'wizard', 'datacenter_update'
...
def main(q, i, params, tags):
    ...
    locations = cloudapi.location.list()['result']['locationinfo']
    locationDict = dict([(location['guid'], location['name']) for location in locations])
    locationDict['new'] = 'Create new location'
    ...
    tab = form.addTab('main', 'Update Datacenter')
    tab.addText('name', 'Name',value=datacenter.name, message='Please enter the datacenter name', optional=False)
    tab.addMultiline('description', 'Description', value=datacenter.description, message='Please enter the datacenter description')
    tab.addText("latitude", "Latitude", validator="^\d*(\.\d+)?$", value=datacenter.coordinates.latitude)
    tab.addText("longitude", "Longitude", validator="^\d*(\.\d+)?$", value=datacenter.coordinates.longitude)
    tab.addChoice('feed', 'Feed', feedDict, message='Please select a feed')
    
    tagobj = q.base.tags.getObject(datacenter.tags or '')
    ...
    cloudapi.datacenter.updateModelProperties(datacenterguid, name=tab.elements['name'].value,
                                               description=tab.elements['description'].value,
                                               clouduserguid=datacenter.clouduserguid,
