...
def main(q, i, params, tags):
    rootobject = 'resourcegroup'
    domain = "racktivity"
    appname = params['appname']
    view_name = '%s_view_%s_device' % (domain, rootobject)
    ...
    if not connection.viewExists(domain, rootobject, view_name):
        ...
        view.setCol('datacenter',q.enumerators.OsisType.UUID,True)
        view.setCol('device',q.enumerators.OsisType.UUID,True)
        connection.viewAdd(view)
        indexes =  [ 'name', 'datacenter', 'device']
