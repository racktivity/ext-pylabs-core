...
def main(q, i, p, params, tags):
    ...
    p.api.actor.racktivity.meteringdevice.powerOnPowerPort(meteringdeviceguid, master.meteringdevicetype, master.network.ipaddress, master.network.port, meteringdevice.id, portid, master.accounts[0].login, master.accounts[0].password)
