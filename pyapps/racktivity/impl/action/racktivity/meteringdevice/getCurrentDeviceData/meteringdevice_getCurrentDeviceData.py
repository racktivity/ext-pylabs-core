...
def main(q, i, p, params, tags):
    ...
    result = p.api.actor.racktivity.meteringdevice.getDeviceData(meteringdeviceguid, master.meteringdevicetype, master.network.ipaddress, master.network.port, meteringdevice.id, datatype, master.accounts[0].login, master.accounts[0].password)
