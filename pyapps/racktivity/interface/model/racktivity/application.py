...
class application(model.RootObjectModel):
    ...
    #@doc check model with reality check
    checkreality = model.Boolean(thrift_id=22)
    
    #@doc external ref for this application
    id = model.String(thrift_id= 23)
    
    #@doc series of tags format
    tags = model.String(thrift_id=24)

    #@doc access control list
    acl = model.Object(acl,thrift_id=25)