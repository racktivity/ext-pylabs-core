...
from pymonkey.messages.ErrorConditionType import ErrorConditionTypeFactory
...
class ErrorconditionHandler():
    ...
    def _exceptionhook(self, ttype, errorObject, tb, stop=True):
        """ every fatal error in pymonkey or by python itself will result in an exception
    ...
    def _dealWithRunningAction(self):
        ...
        such that when an action fails it throws a PYMonkey event and is directed to be handled here
        """
