...
def testAddInputPowerPort_2():
    ...
    cloudapi = getCloudapi()
    sequence = -2
    assert_raises(CloudApiException, cloudapi.meteringdevice.addInputPowerPort, getMeteringdeviceGuid(), PORT_LABEL_ONE, sequence)
...
def testAddInputPowerPort_3():
    ...
    sequence = 1
    cloudapi.meteringdevice.addInputPowerPort(getMeteringdeviceGuid(), PORT_LABEL_ONE, sequence)
    assert_raises(CloudApiException, cloudapi.meteringdevice.addInputPowerPort, getMeteringdeviceGuid(), PORT_LABEL_TWO, sequence)
    cloudapi.meteringdevice.deleteInputPowerPort(getMeteringdeviceGuid(), PORT_LABEL_ONE)
